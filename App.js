    ...
    return(
        <div className="header">
            <div className="logo-container">
                <img className="logo" src="https://www.logodesign.net/logo/smoking-burger-with-lettuce-3624ld.png?nwm=1&nws=1&industry=fast-food&txt_keyword=All" alt="food-logo"/>
            </div>
...
const RestaurantCard = (props) => {
    ...
    return(
        <div className="res-card">
            <img className="food-img" alt="food-img" src={'https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_264,h_288,c_fill/' + cloudinaryImageId} /> 
            <h3>{name}</h3>
            <h4>{cuisines.join(', ')}</h4>
